...
function addObstacleImages() {
  document
    .getElementById("wcimg")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("wd1img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("wd2img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("wd3img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("wsimg")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("wr1img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("wr2img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("wr3img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("wr4img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("wr5img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("wr6img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("ws1img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("ws2img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("ws3img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("ws4img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("ws5img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("ws6img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
    .getElementById("ws7img")
    .setAttribute("src", "meta/opponent" + getRandomNumber(1, 4) + ".png");
  document
...
onmousedown = function (e) {
  if (
    2 == play &&
    window.event.which == 1 /*detects left click*/ &&
    e.clientX >= 450 &&
    e.clientX <= 950 &&
    e.clientY >= 200 &&
    e.clientY <= 600
...
onmousemove = function (e) {
  if (1 == play) {
    ...
    if (e.clientX < 450 + redWidth / 2) redX = 450;
    else if (e.clientX > 950 - redWidth / 2) redX = 950 - redWidth;
    if (e.clientY < 200 + redHeight / 2) redY = 200;
    else if (e.clientY > 600 - redHeight / 2) redY = 600 - redHeight;
    document
      ...
      .setAttribute(
        ...
        "position:absolute; top:" +
          ...
          "px; height:" +
          redHeight +
          "px; background-color:#ff0000; border-radius:" +
          redWidth / 2 +
          "px; z-index:0; cursor:none"
      );
  }
};
...
function fpsStart() {
  if (1 == play) {
    ...
    document
      .getElementById("fpsdiv")
      .setAttribute("style", "position:absolute; top:160px; left:450px;");
  }
}
...
//white dot1 = wd1_
var wd1_top_sourceMain = 300,
  wd1_left_sourceMain = 900,
  wd1_delayRange1 = 1,
  wd1_delayRange2 = 10,
  wd1_top_destRange1 = 200,
  wd1_top_destRange2 = 590,
  wd1_left_destRange1 = 450,
  wd1_left_destRange2 = 940,
  wd1_id = "whiteDot1",
  wd1_stylestr = "width:10px; height:10px; border-radius:5px; ";
//white dot2 = wd2_
var wd2_top_sourceMain = 300,
  wd2_left_sourceMain = 900,
  wd2_delayRange1 = 1,
  wd2_delayRange2 = 10,
  wd2_top_destRange1 = 200,
  wd2_top_destRange2 = 590,
  wd2_left_destRange1 = 450,
  wd2_left_destRange2 = 940,
  wd2_id = "whiteDot2",
  wd2_stylestr = "width:10px; height:10px; border-radius:5px; ";
//white dot3 = wd3_
var wd3_top_sourceMain = 300,
  wd3_left_sourceMain = 900,
  wd3_delayRange1 = 1,
  wd3_delayRange2 = 10,
  wd3_top_destRange1 = 200,
  wd3_top_destRange2 = 590,
  wd3_left_destRange1 = 450,
  wd3_left_destRange2 = 940,
  wd3_id = "whiteDot3",
  wd3_stylestr = "width:10px; height:10px; border-radius:5px; ";
//white circle = wc_
var wc_top_sourceMain = 500,
  wc_left_sourceMain = 700,
  wc_delayRange1 = 5,
  wc_delayRange2 = 15,
  wc_top_destRange1 = 200,
  wc_top_destRange2 = 550,
  wc_left_destRange1 = 450,
  wc_left_destRange2 = 900,
  wc_id = "whiteCircle",
  wc_stylestr = "width:50px; height:50px; border-radius:25px; ";
//white square = ws_
var ws_top_sourceMain = 250,
  ws_left_sourceMain = 600,
  ws_delayRange1 = 10,
  ws_delayRange2 = 20,
  ws_top_destRange1 = 200,
  ws_top_destRange2 = 570,
  ws_left_destRange1 = 450,
  ws_left_destRange2 = 920,
  ws_id = "whiteSquare",
  ws_stylestr = "width:30px; height:30px;";
//white rect = wr_
var wr_top_sourceMain = 450,
  wr_left_sourceMain = 550,
  wr_delayRange1 = 5,
  wr_delayRange2 = 10,
  wr_top_destRange1 = 200,
  wr_top_destRange2 = 580,
  wr_left_destRange1 = 450,
  wr_left_destRange2 = 800,
  wr_id = "whiteRect",
  wr_stylestr = "width:140px; height:20px;";
//white square1 = ws1_
var ws1_top_sourceMain = 200,
  ws1_left_sourceMain = 450,
  ws1_delayRange = 1,
  ws1_id = "whiteSquare1",
  ws1_stylestr = "width:25px; height:25px;"; // top_dest=575, left_dest=925
//white square2 = ws2_
var ws2_top_sourceMain = 575,
  ws2_left_sourceMain = 450,
  ws2_delayRange = 1,
  ws2_id = "whiteSquare2",
  ws2_stylestr = "width:25px; height:25px;"; // top_dest=575, left_dest=925
//white square3 = ws3_
var ws3_top_sourceMain = 575,
  ws3_left_sourceMain = 925,
  ws3_delayRange = 1,
  ws3_id = "whiteSquare3",
  ws3_stylestr = "width:25px; height:25px;"; // top_dest=575, left_dest=925
//white square4 = ws4_
var ws4_top_sourceMain = 200,
  ws4_left_sourceMain = 925,
  ws4_delayRange = 1,
  ws4_id = "whiteSquare4",
  ws4_stylestr = "width:25px; height:25px;"; // top_dest=575, left_dest=925
//white square1 = ws5_
var ws5_top_sourceMain = 200,
  ws5_left_sourceMain = 450,
  ws5_delayRange = 1,
  ws5_id = "whiteSquare5",
  ws5_stylestr = "width:25px; height:25px;"; // top_dest=575, left_dest=925
//white square2 = ws6_
var ws6_top_sourceMain = 575,
  ws6_left_sourceMain = 450,
  ws6_delayRange = 1,
  ws6_id = "whiteSquare6",
  ws6_stylestr = "width:25px; height:25px;"; // top_dest=575, left_dest=925
//white square3 = ws7_
var ws7_top_sourceMain = 575,
  ws7_left_sourceMain = 925,
  ws7_delayRange = 1,
  ws7_id = "whiteSquare7",
  ws7_stylestr = "width:25px; height:25px;"; // top_dest=575, left_dest=925
//white square4 = ws8_
var ws8_top_sourceMain = 200,
  ws8_left_sourceMain = 925,
  ws8_delayRange = 1,
  ws8_id = "whiteSquare8",
  ws8_stylestr = "width:25px; height:25px;"; // top_dest=575, left_dest=925

function SendObstacles() {
  SendWhiteRandomTrajectory(
    wd1_top_sourceMain,
    wd1_left_sourceMain,
    wd1_delayRange1,
    wd1_delayRange2,
...
function SendWhiteFixedTrajectory(
  top_source,
  left_source,
  delay,
  id,
...
function MoveWhiteFixedTrajectory(
  top_source,
  left_source,
  id,
  stylestr,
  ...
  if (1 == play) {
    setTimeout(function () {
      fpsStart();
      if (top_source < top_dest) top_source++;
      else if (top_source > top_dest) top_source--;
      if (left_source < left_dest) left_source++;
      else if (left_source > left_dest) left_source--;
...
function SendWhiteRandomTrajectory(
  top_source,
  left_source,
  delayRange1,
  delayRange2,
  ...
  var top_dest = getRandomNumber(top_destRange1, top_destRange2),
    left_dest = getRandomNumber(left_destRange1, left_destRange2);
...
function MoveWhiteRandomTrajectory(
  top_source,
  left_source,
  delayRange1,
  delayRange2,
...
function DetectCollision(id) {
  ...
  if (play == 1) {
    setTimeout(function () {
      ...
      dia = redWidth / 2;
      if (id == "whiteDot1")
        (x2 = wd1_left_sourceMain + 5),
          (y2 = wd1_top_sourceMain + 5),
          (dia += 5),
          (typeOfCollision = 0);
      else if (id == "whiteDot2")
        (x2 = wd2_left_sourceMain + 5),
          (y2 = wd2_top_sourceMain + 5),
          (dia += 5),
          (typeOfCollision = 0);
      else if (id == "whiteDot3")
        (x2 = wd3_left_sourceMain + 5),
          (y2 = wd3_top_sourceMain + 5),
          (dia += 5),
          (typeOfCollision = 0);
      else if (id == "whiteCircle")
        (x2 = wc_left_sourceMain + 25),
          (y2 = wc_top_sourceMain + 25),
          (dia += 25),
          (typeOfCollision = 0);
      else if (id == "whiteSquare")
        (x2 = ws_left_sourceMain + 15),
          (y2 = ws_top_sourceMain + 15),
          (rect_width = 30),
          (rect_height = 30),
          (typeOfCollision = 1);
      else if (id == "whiteRect")
        (x2 = wr_left_sourceMain + 75),
          (y2 = wr_top_sourceMain + 10),
          (rect_width = 140),
          (rect_height = 20),
          (typeOfCollision = 1);
      else if (id == "whiteSquare1")
        (x2 = ws1_left_sourceMain + 12),
          (y2 = ws1_top_sourceMain + 12),
          (rect_width = 25),
          (rect_height = 25),
          (typeOfCollision = 1);
      else if (id == "whiteSquare2")
        (x2 = ws2_left_sourceMain + 12),
          (y2 = ws2_top_sourceMain + 12),
          (rect_width = 25),
          (rect_height = 25),
          (typeOfCollision = 1);
      else if (id == "whiteSquare3")
        (x2 = ws3_left_sourceMain + 12),
          (y2 = ws3_top_sourceMain + 12),
          (rect_width = 25),
          (rect_height = 25),
          (typeOfCollision = 1);
      else if (id == "whiteSquare4")
        (x2 = ws4_left_sourceMain + 12),
          (y2 = ws4_top_sourceMain + 12),
          (rect_width = 25),
          (rect_height = 25),
          (typeOfCollision = 1);
      else if (id == "whiteSquare5")
        (x2 = ws5_left_sourceMain + 12),
          (y2 = ws5_top_sourceMain + 12),
          (rect_width = 25),
          (rect_height = 25),
          (typeOfCollision = 1);
      else if (id == "whiteSquare6")
        (x2 = ws6_left_sourceMain + 12),
          (y2 = ws6_top_sourceMain + 12),
          (rect_width = 25),
          (rect_height = 25),
          (typeOfCollision = 1);
      else if (id == "whiteSquare7")
        (x2 = ws7_left_sourceMain + 12),
          (y2 = ws7_top_sourceMain + 12),
          (rect_width = 25),
          (rect_height = 25),
          (typeOfCollision = 1);
      else if (id == "whiteSquare8")
        (x2 = ws8_left_sourceMain + 12),
          (y2 = ws8_top_sourceMain + 12),
          (rect_width = 25),
          (rect_height = 25),
          (typeOfCollision = 1);
      if (typeOfCollision == 0)
        ...
        isCollision = CircleRectCollisionCondtion(
          x1,
          y1,
          redWidth / 2,
          x2,
      ...
      if (true == isCollision) CollisionDetected();
      DetectCollision(id);
    }, 1);
  }
}

function CircleRectCollisionCondtion(
  circle_x,
  circle_y,
  circle_r,
  rect_x,
  ...
  if (circleDistance_x > rect_width / 2 + circle_r) {
    return false;
  }
  if (circleDistance_y > rect_height / 2 + circle_r) {
    return false;
  }
  ...
  var cornerDistance_sq =
    (circleDistance_x - rect_width / 2) ^
    (2 + (circleDistance_y - rect_height / 2)) ^
    2;
...
function CollisionDetected() {
  ...
  document.getElementById("ssmsg").innerHTML =
    "\u263a Left click in game window to reload game.";
  document
    .getElementById("currS")
    .setAttribute(
      "style",
      "text-align:justify;text-align:center;color:#ffffff;font-size:20px"
    );
  document
    .getElementById("bestS")
    .setAttribute(
      "style",
      "text-align:justify;text-align:center;color:#ffffff;font-size:20px"
    );
  document
    .getElementById("ssmsgdiv")
    .setAttribute(
      "style",
      "position:absolute; max-width:300px; top:420px; left:139px;"
    );
...
function CopyBtnClick(flag) {
  var flagString;
  if (flag == 1) flagString = "btc";
  else flagString = "email";
